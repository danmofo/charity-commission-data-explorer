...
public abstract class HibernateDao<E, K extends Serializable> {
    ...
    public HibernateDao() {
        ...
        // However, this doesn't work if you don't extend this class (getGenericSuperclass returns Object),
        // and I couldn't find a way to actually get that type information.
